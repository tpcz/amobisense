...
public class Wifi extends PowerComponent {
  public static class WifiData extends PowerData {
    ...
    public int numSeenWifi;

    private WifiData() {
    }

    public void init(	double packets, long uplinkBytes, long downlinkBytes, double uplinkRate, 
    					double linkSpeed, int powerState) {
      wifiOn = true;
  ...
  //  ScanResult[] scan =  (ScanResult[]) wifiManager.getScanResults().toArray();
